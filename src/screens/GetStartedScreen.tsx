    ...
    return (
        <View className="flex-1">
            ...
            <View className="flex flex-1 justify-center">
                    ...
                    {data.map((screen) => (
                        ...
                        >
                            ...
                            <View className="mx-8 space-y-8">
                                <Text
                                    className={`text-center text-[22px] leading-[34px] tracking-[-0.8px] ${colorScheme === "dark"
                                            ? "text-[#DADADA]"
                                            : "text-[#787878]"
                                        }`}
                                ...
                                <Text
                                    className={`${screen.id === 2 ? "mx-7" : "mx-8"
                                        }  text-justify text-[14px] leading-[24px] tracking-[-0.3px] ${colorScheme === "dark"
                                            ? "text-[#C1C1C1]"
                                            : "text-[#545454]"
                                        }`}
                ...
                {showButton && (
                    <TouchableOpacity
                        className={`rounded-xl ${colorScheme === "dark"
                                ? "bg-zinc-600"
                                : "bg-zinc-300"
                    ...
                    >
                        <Text
                            className={`py-[8px] text-center text-[18px] ${colorScheme === "dark"
                                    ? "text-white"
                                    : "text-zinc-600"
                                } opacity-90`}
                            style={{ fontFamily: "Medium" }}
                ...
                <View
                    className={`flex ${showButton ? "flex-[0.1]" : "flex-[0.13]"
                        } flex-row items-start justify-center space-x-2`}
                >
                    {[1, 2, 3].map((i) => (
                        <View
                            key={i}
                            className={`h-2 w-2 rounded-full ${colorScheme === "dark"
                                    ? "bg-white"
                                    : "bg-zinc-600"
